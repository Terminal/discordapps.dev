  ...
  render() {
    return (
      <div className={styles.navbar}>
        <div className={ConstructCSS(displayCSS.desktop, Modesta.navContainer, Modesta.default, styles.navContainer)}>
          <h1 className={ConstructCSS(Modesta.navTitle, styles.desktopHeading)}>
